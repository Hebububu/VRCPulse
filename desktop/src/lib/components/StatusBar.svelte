...
<header class="status-bar">
  ...
  <div class="right">
    <a href="https://discord.gg/JW3XrskcpK" target="_blank" rel="noopener" class="social-link" title="Discord">
    ...
    <a href="https://github.com/Hebububu/VRCPulse" target="_blank" rel="noopener" class="social-link" title="GitHub">
    ...
    {#if isTauriApp}
      <button class="social-link" onclick={() => push('/settings')} title="Settings">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
    ...
    {/if}
    <button class="lang-btn" onclick={toggleLocale}>{langLabel}</button>
