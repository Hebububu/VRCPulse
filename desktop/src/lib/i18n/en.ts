export default {
  ...
  'component.collapse': 'Collapse components',
  'component.expand': 'Expand components',
  'component.ago': 'ago',
  'component.now': 'Now',
  'component.name.API / Website': 'API / Website',
  'component.name.Realtime Networking': 'Realtime Networking',
  'component.name.Authentication / Login': 'Authentication / Login',
  'component.name.Social / Friends List': 'Social / Friends List',
  'component.name.SDK Asset Uploads': 'SDK Asset Uploads',
  'component.name.Realtime Player State Changes': 'Realtime Player State Changes',
  'component.name.USA, West (San José)': 'USA, West (San José)',
  'component.name.USA, East (Washington D.C.)': 'USA, East (Washington D.C.)',
  'component.name.Europe (Amsterdam)': 'Europe (Amsterdam)',
  'component.name.Japan (Tokyo)': 'Japan (Tokyo)',
