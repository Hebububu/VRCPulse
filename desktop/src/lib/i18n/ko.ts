export default {
  ...
  'component.collapse': '컴포넌트 접기',
  'component.expand': '컴포넌트 펼치기',
  'component.ago': '전',
  'component.now': '현재',
  'component.name.API / Website': 'API / 웹사이트',
  'component.name.Realtime Networking': '실시간 네트워킹',
  'component.name.Authentication / Login': '인증 / 로그인',
  'component.name.Social / Friends List': '소셜 / 친구 목록',
  'component.name.SDK Asset Uploads': '유니티 SDK 에셋 업로드',
  'component.name.Realtime Player State Changes': '실시간 플레이어 상태 변경',
  'component.name.USA, West (San José)': '미국 서부 (산 호세)',
  'component.name.USA, East (Washington D.C.)': '미국 동부 (워싱턴 D.C.)',
  'component.name.Europe (Amsterdam)': '유럽 (암스테르담)',
  'component.name.Japan (Tokyo)': '일본 (도쿄)',
