...
use crate::discord::shared::respond_error;
use crate::infrastructure::database;
use crate::infrastructure::state::AppStateKey;
use crate::registration::repository::{GuildConfigRepository, UserConfigRepository};
...
async fn handle_config_set<'a>(
    ...
    if let Err(e) = vrcpulse_core::collector::config::set_interval(db, poller, seconds).await {
